...
function AppRoutes({
  ...
  return (
    <Routes>
      {/* Public Routes */}
      <Route path="/" element={<Home isAuthenticated={isAuthenticated} userRole={userRole} userId={userId} />} />
      <Route path="/login" element={isAuthenticated ? (userRole === "superadmin" || userRole === "admin" ? <Navigate to="/dashboard" /> : <Navigate to="/" />) : <Login setAuth={setAuth} setUserRole={setUserRole} setUserId={setUserId} />} />
      <Route path="/register" element={<Register />} />
      <Route path="/forgot-password" element={<ForgotPassword />} />
      <Route path="/reset-password" element={<ResetPassword />} />
      <Route path="/verify-email" element={<VerifyEmail />} />
      <Route path="/auth/success" element={<AuthSuccess setAuth={setAuth} setUserRole={setUserRole} setUserId={setUserId} />} />
